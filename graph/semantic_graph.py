...
class SemanticGraph:
    ...
    def __init__(self,configs : bidict,graph :nk.graph,GANGSTR=True,edges_infos=None,args=None):
...
##########################################
    ...
    def k_shortest_path(self,source, target,k,cutoff=10,use_weights=True):
        '''
